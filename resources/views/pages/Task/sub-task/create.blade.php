        ...
        <nav class="navbar navbar-main navbar-expand-lg mx-5 px-0 shadow-none rounded" id="navbarBlur" navbar-scroll="true">
            <div class="container-fluid py-1 px-2">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bold mb-0">Create Sub Task</h6>
                </nav>
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Create Sub Task</h6>
                                    <p class="text-sm">Create Sub Task</p>
                                </div>
                                <div class="ms-auto d-flex">
                                    <a href="/task/{{ $id_event }}/sub-task/{{ $id_task }}" class="btn btn-sm btn-dark btn-icon d-flex align-items-center me-2">
                        ...
                        <div class="card-body px-0 py-0">
                            <form action="/task/{{ $id_event }}/sub-task/{{ $id_task }}/create" method="post">
                                @csrf
                                <div class="row">
