                ...
                <div class="col-12 ">
                    <div class="card border shadow-xs mb-4">
                        ...
                        <div class="card-body px-0 py-0">
                            <form action="/task/{{ $sub_task->id_event }}/sub-task/{{ $sub_task->tasks_idtask }}/update/{{ $sub_task->id }}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-12 px-5 py-2 pt-4">
                                        <label for="name">Name</label>
                                        <input type="text" name="name" id="name" class="form-control" placeholder="Enter Name" value="{{ $sub_task->name }}">
                                    </div>
                                    <div class="col-12 px-5 py-2">
                                        <label for="name">Description</label>
                                        <input type="text" name="description" id="" class="form-control" placeholder="Enter Description" value="{{ $sub_task->description }}">
                                    </div>
