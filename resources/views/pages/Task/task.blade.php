    ...
    <nav class="navbar navbar-main navbar-expand-lg mx-5 px-0 shadow-none rounded" id="navbarBlur" navbar-scroll="true">
        <div class="container-fluid py-1 px-2">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bold mb-0">Main Task</h6>
            </nav>
                ...
                <div class="card border shadow-xs mb-4">
                    <div class="card-header border-bottom pb-0">
                        <div class="d-sm-flex align-items-center mb-3">
                            <div>
                                <h6 class="font-weight-semibold text-lg mb-0">Main Task</h6>
                            ...
                            <div class="ms-auto d-flex">
                                ...
                                <a href="/task/create/{{ $id }}" class="btn btn-sm btn-dark btn-icon d-flex align-items-center mb-0 me-2 w-50">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <a href="/task/{{ $item->event->id }}/update/{{ $item->id }}" class="text-secondary font-weight-bold text-xs" data-bs-toggle="tooltip" data-bs-title="Edit">
                                            ...
                                            <a href="/task/{{ $item->event->id }}/delete/{{ $item->id }}" class="text-secondary font-weight-bold text-xs ms-3" data-bs-toggle="tooltip" data-bs-title="Delete">
