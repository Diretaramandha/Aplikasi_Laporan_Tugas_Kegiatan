        ...
        <div class="container-fluid py-1 px-2">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-1 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Event Detail</li>
                </ol>
                <h6 class="font-weight-bold mb-0">Event Detail</h6>
            </nav>
                ...
                <div class="card border shadow-xs mb-4">
                    <div class="card-header border-bottom pb-0">
                        <div class="d-sm-flex align-items-center mb-3">
                            <div>
                                <h6 class="font-weight-semibold text-lg mb-0">Event Detail</h6>
                                <p class="text-sm mb-sm-0">You can see the tasks in the event</p>
                            </div>
                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center justify-content-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="ms-4"> {{ $key+1 }}</p>
                                        </td>
                                        <td>
                                            <div class="d-flex px-2">
                                                <div class="my-auto ms-3">
                                                    <h6 class="mb-0 text-sm">{{ $item->event->name }}</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="align-middle">
                                            <div class="d-flex">
                                                <div class="ms-2">
                                                    <li class="text-secondary text-sm mb-0">{{ $item->name }}</li>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="">
