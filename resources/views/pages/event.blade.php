                    ...
                    <div class="card-header border-bottom pb-0">
                        <div class="d-sm-flex align-items-center">
                            ...
                            <div class="ms-auto d-flex">
                                <a href="/event/create" class="btn btn-sm btn-dark btn-icon d-flex align-items-center me-2">
                                    <span class="btn-inner--icon">
                                        <img src="{{ asset('assets/img/logos/event-add.png') }}" alt="" width="16px" height="18px">
                                    </span>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <a href="/event/edit/{{ $item->id }}" class="text-secondary font-weight-bold text-xs" data-bs-toggle="tooltip" data-bs-title="Edit">
                                            ...
                                            <a href="/event/detail/{{ $item->id }}" class="text-secondary font-weight-bold text-xs ms-2" data-bs-toggle="tooltip" data-bs-title="Delete">
                                                <img src="{{ asset('img/delete.png') }}" alt="" class="" width="21px" height="22px">
                                            </a>
                                        </td>
                                    </tr>
                                    @endforeach
