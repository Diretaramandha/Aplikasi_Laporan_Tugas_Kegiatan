                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <a href="/task/{{ $item->id }}" class="btn btn-sm btn-dark btn-icon me-2 my-2 opacity-5">
                                                <span class="btn-inner--icon">
                                        ...
                                        <td class="align-middle text-center">
                                            <a href="/event/update/{{ $item->id }}" class="text-secondary font-weight-bold text-xs" data-bs-toggle="tooltip" data-bs-title="Edit">
