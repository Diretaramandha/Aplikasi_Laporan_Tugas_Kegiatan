        ...
        <div class="container-fluid py-1 px-2">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-1 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Event Create</li>
                </ol>
                <h6 class="font-weight-bold mb-0">Event Create</h6>
            </nav>
                ...
                <div class="card border shadow-xs mb-4">
                    <div class="card-header border-bottom pb-0">
                        <div class="d-sm-flex align-items-center">
                            <div>
                                <h6 class="font-weight-semibold text-lg mb-0">Event Create</h6>
                                <p class="text-sm">You can make an event</p>
                            </div>
                        ...
                        <form action="/event/create" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 px-5 py-2">
                                    ...
                                    <input type="date" name="date" id="" class="form-control" placeholder="Enter Date">
                                </div>
