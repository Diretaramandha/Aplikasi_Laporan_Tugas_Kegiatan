                ...
                <div class="col-12 ">
                    <div class="card border shadow-xs mb-4">
                        ...
                        <div class="card-body px-0 py-0">
                            <form action="/report/update/{{ $id_event }}/{{ $task->id }}/{{ $report->id }}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-12 px-5 py-2 pt-4">
                                        <label for="name">Name</label>
                                        <input type="text" name="name" id="name" class="form-control" placeholder="Enter Name" value="{{ $report->name }}">
                                    </div>
                                    <div class="col-12 px-5 py-2">
                                        <label for="time">Date & Time</label>
                                        <input type="datetime-local" name="duetime" id="time" class="form-control" placeholder="Enter Time" value="{{ $report->duetime }}">
                                    </div>
