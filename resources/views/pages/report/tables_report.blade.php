                                        ...
                                        @foreach ($task as $key => $item)
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <a href="/report/update/{{ $id_task }}/{{ $item->id }}" class="text-secondary font-weight-bold text-xs" data-bs-toggle="tooltip" data-bs-title="Edit">
                                                    ...
                                                    <a href="/report/delete/{{ $item->id }}" class="text-secondary font-weight-bold text-xs ms-2" data-bs-toggle="tooltip" data-bs-title="Edit">
                                                        <img src="{{ asset('img/delete.png') }}" alt="" width="16" height="18" srcset="">
                                                    </a>
                                                </td>
                                            </tr>
                                        @endforeach
